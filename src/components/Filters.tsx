...
export default function Filters() {
  ...
  return (
    <div
      ...
      } py-20  transition-all duration-150 lg:block hidden items-center bg-white`}
    >
      <div
        className={`${
      ...
      >
        <strong className="xl:text-2xl text-xl first-letter:uppercase text-zinc-800 drop-shadow-lg shadow-black">
        ...
        <div className="mt-9  w-fit items-center flex flex-col gap-6 ">
          {handleCategoriesFilters().map((category, i) => (
            <button
              ...
              className={`focus:border-brand text-sm xl:text-base border-b-4 border-b-transparent rounded px-2 uppercase`}
            >
              {category}
            </button>
          ))}
        ...
        <div className="mt-14">
          <strong className="xl:text-2xl text-xl text-zinc-800 drop-shadow-lg shadow-black">
            Price
          </strong>
          <form action="" className="flex mt-9 gap-4 flex-col">
            <label className="flex flex-col text-left">
              ...
              <input
                placeholder="R$ 200"
                className="rounded px-2 border text-zinc-700  xl:w-28 w-36 h-7"
                type="number"
              />
            </label>
            <label className="flex flex-col text-left">
